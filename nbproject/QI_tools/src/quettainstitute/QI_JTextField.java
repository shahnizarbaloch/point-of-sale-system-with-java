        ...
        switch(validationType){
           ...
           case 1: 
            ...
            case 2: 
               ...
               /*
               if(v.length()>50){
                  JOptionPane.showMessageDialog(null, "You Have Exceeded Limit which is 50 charecters");
                  jtf.addFocusListener(new FocusListener(){
                      ...
                      public void focusLost(FocusEvent e) {
                          jtf.setBorder(BorderFactory.createLineBorder(Color.GRAY));
                      }
